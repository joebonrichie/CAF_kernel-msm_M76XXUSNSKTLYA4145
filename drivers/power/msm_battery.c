...
static void msm_batt_update_psy_status(void)
{
	...
	/* SONY ADDITIONS, Edison: add ATS & ERROR EVENT 20111122 ++ */
	...
	/* SONY ADDITIONS, Edison add for warning event 20111122 ++ */	
	...
	/* SONY ADDITIONS, [Arima Edison] add for update charger current info ++ */
	...
	// SONY ADDITIONS, update battery capacity ++	
	...
	/* SONY ADDITIONS, Edison add to update charging state if full charged ++ */
