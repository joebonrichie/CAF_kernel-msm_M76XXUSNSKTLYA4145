					...
					int count, int *eof, void *data)
{
	...
	int clength = 0;
	*eof = 1;
	//MTD-CONN-DL-CID15869-00*[
	//return sprintf(page, "btwake:%u\n", gpio_get_value(bsi->ext_wake));
  c = snprintf( NULL, 0, "btwake:%u\n", gpio_get_value(bsi->ext_wake));
  if (!page)
		return -ENOMEM;
  clength = snprintf( page, c + 1, "btwake:%u\n", gpio_get_value(bsi->ext_wake));
  return clength;
	//MTD-CONN-DL-CID15869-00*]
}
					...
					int count, int *eof, void *data)
{
	...
	int clength = 0;
	*eof = 1;
	//MTD-CONN-DL-CID15870-00*[
	//return sprintf(page, "hostwake: %u \n", gpio_get_value(bsi->host_wake));
  c = snprintf( NULL, 0, "hostwake: %u \n", gpio_get_value(bsi->host_wake));
  if (!page)
  	return -ENOMEM;
  clength = snprintf( page, c + 1, "hostwake: %u \n", gpio_get_value(bsi->host_wake));
  return clength;
  //MTD-CONN-DL-CID15870-00*]
}
					...
					int count, int *eof, void *data)
{
	...
	*eof = 1;
  //MTD-CONN-DL-CID15871-00*[
	//return sprintf(page, "asleep: %u\n", asleep);
	c = snprintf( NULL, 0, "asleep: %u\n", asleep);
  if (!page)
  	return -ENOMEM;
  clength = snprintf( page, c + 1, "asleep: %u\n", asleep);
  return clength;
  //MTD-CONN-DL-CID15871-00*]
}
					...
					int count, int *eof, void *data)
{
	...
	*eof = 1;
  //MTD-CONN-DL-CID15872-00*[
	//return sprintf(page, "proto: %u\n", proto);
	c = snprintf( NULL, 0, "proto: %u\n", proto);
  if (!page)
  	return -ENOMEM;
  clength = snprintf( page, c + 1, "proto: %u\n", proto);
  return clength;
  //MTD-CONN-DL-CID15872-00*]
}
